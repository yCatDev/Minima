...
namespace MinimaEngine
{
    public static class InputManager
    {
        ...
        public static void SetMousePosition(Vector2i newPos)
            => Mouse.SetPosition(newPos);

        public static Vector2f ScreenVectorToGame(Vector2i screenVector)
            => throw new NotImplementedException();
        
        public static Vector2f GameVectorToScreen(Vector2i gameVector)
            => throw new NotImplementedException();
